...
python /dss/dsshome1/0B/ge49rev3/shnn-repo/src/double_pendulum_hnn_on_cpu_experiment.py --save-dir /gpfs/scratch/pr63so/ge49rev3/shnn-paper/double-pendulum-hnn-on-cpu --device cpu --batch-size 2048 --total-steps 180000
